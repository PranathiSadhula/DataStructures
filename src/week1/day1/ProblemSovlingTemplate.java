...
public class ProblemSovlingTemplate {
	/*
	 * 1) Did I understand the problem? Yes / No
	 * 
	 * 	-> If you understand the problem --> what to follow
	 *  -> If you do not understand the problem --> Ask for more !! 
	 * 
	 ...
	 *  = Yes (great --> do I know multiple solutions?)
	 *  = No (Sorry, Can I have some hints?)
	 *  
	 * 4) Ask for hints !!
	 * 
	 *  - Put it nicely
